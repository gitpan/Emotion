...
Most of the complexity of this module resides in learning how to
annotate free-form text with information about what competition is
taking place.  If you haven't studied http://ghost-wheel.net then go
do that first.
...
really C<accepts>, C<observes>, or even merely:
...
variety of situations do not trigger the need for resolution, and
