...
Most of the complexity of this module is learning how to annotate
free-form text with information about what competition is taking
place.  The API is simple.
...
The code assumes that you are using the expat based XML::Parser.  It
would not be difficult to make the code generic enough to interface
with any XML parser.
